<template>
    <div
        class="grid gap-3 sm:divide-aps-green overflow-hidden rounded-lg md:bg-gray-200 md:shadow md:grid md:grid-cols-2 md:gap-px md:divide-y-0">
        <div
            class="shadow rounded rounded-tl-lg rounded-tr-lg sm:rounded-tr-none group relative bg-white p-6 focus-within:ring-inset focus-within:ring-indigo-500">
            <div>
                <span class="inline-flex rounded-lg p-3 bg-blue-50 text-blue-700 ring-white">
        ...
        <div
            ...
            <div>
                <span class="inline-flex rounded-lg p-3 bg-teal-50 text-teal-700 ring-white">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="bi bi-patch-question-fill w-6 h-6" viewBox="0 0 18 18" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
        ...
        <div
            class="shadow rounded sm:rounded-tl-lg sm:rounded-tr-none group relative bg-white p-6 focus-within:ring-inset focus-within:ring-indigo-500">
            <div>
                <span class="inline-flex rounded-lg p-3 bg-orange-50 text-aps-orange ring-white">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="bi bi-book w-6 h-6" viewBox="0 0 18 18" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
        ...
        <div
            class="shadow rounded sm:rounded-tr-lg sm:rounded-tr-none group relative bg-white p-6 focus-within:ring-inset focus-within:ring-indigo-500">
            <div>
                <span class="inline-flex rounded-lg p-3 bg-yellow-50 text-yellow-700 ring-white">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="bi bi-journal w-6 h-6" viewBox="0 0 18 18" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
        ...
        <div
            ...
            <div class="mt-8">
                <h3 class="text-base font-semibold leading-6 text-gray-900">
                    <RouterLink to="/dashboard/cgpacalculator" class="focus:outline-none text-[12px] md:text-lg">
                        <span class="absolute inset-0" aria-hidden="true"></span>
                        CGPA Calculator
                    </RouterLink>
                </h3>
