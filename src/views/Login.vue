<template>
    <div v-if="loginComponent" class="mt-[-50px] font-display">
        <StudentLogin />
    ...
    <div v-if="!loginComponent">
        <ResetPassword />
        <p class="text-center text-1xl mt-[-120px]" >
            <p @click="login" class="text-blue-500 hover:underline">Do you want to login?</p>
        </p>
    </div>
</template>
<script setup>
