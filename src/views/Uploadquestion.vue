<template>
  <div class="font-display container mx-auto pb-6 font-display mt-5">
    <!-- Tab Buttons -->
    <div class="flex mb-4 justify-center space-x-4">
      <button
        class="tab-btn"
        @click="selectedTab = 'essay'"
        :class="{ 'active-tab': selectedTab === 'essay' }"
      >
        Essay
      </button>
      <button
        class="tab-btn"
        @click="selectedTab = 'cloze'"
        :class="{ 'active-tab': selectedTab === 'cloze' }"
      >
        Cloze (Fill in the blanks)
      </button>
      <button
        class="tab-btn"
        @click="selectedTab = 'mcq'"
        :class="{ 'active-tab': selectedTab === 'mcq' }"
      >
        MCQ
      </button>
    </div>
